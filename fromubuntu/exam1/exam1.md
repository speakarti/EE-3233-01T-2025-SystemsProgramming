...
![gcc and make versions](image-6.png)


##Execution steps

![executing 'make' command - without changing node](image.png)

![executing 'make'](image-1.png)

![Errors in test execution](image-2.png)

![failing at 'file existance check'](image-3.png)

![failing at 'permission denied' test](image-4.png)

![still failing with 1 test](image-5.png)


## Conclusion
I learnt hard way to compile code using make tools.
